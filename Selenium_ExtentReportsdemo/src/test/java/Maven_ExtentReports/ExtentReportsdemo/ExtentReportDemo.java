package Maven_ExtentReports.ExtentReportsdemo;
...
//test.fail("results not found") -  this will help us to fail the test case and make the failed result visible in report
extent.flush();
